...
import flixel.addons.animate.internal.filters.Blend;
...
class BakedInstance extends AtlasInstance
{
	...
	{
		super.draw(camera, index, tlFrame, parentMatrix, transform, Blend.resolve(this.blend, blend), antialiasing, shader);
	}
}
